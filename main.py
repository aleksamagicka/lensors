...
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QTabWidget, QMainWindow, QHeaderView, \
...
class App(QMainWindow):
    ...
    def _refresh_sensors_widget(self):
        ...
        # self.sensors_tree.setModel(None)
        # self.sensors_tree.setModel(self.sensors_model)
        self.sensors_tree.expandAll()
        self.sensors_tree.header().setSectionResizeMode(QHeaderView.ResizeMode.ResizeToContents)
    ...
    def _init_menubar(self):
        ...
        about_action.triggered.connect(self.onHelpTrigerred)
